...
class LocalRepositoryTemp(private val databaseService: DatabaseService) {
    ...
    fun insertDataLocation(city: String, zipCode: String) {
    ...
    fun insertDataManafactura(manufacturer_name: String) {
        CoroutineScope(IO).launch {
    ...
    fun insertDataCar(model_name: String, model_no: String, manufacturer_id: Int) {
        CoroutineScope(IO).launch {
    ...
    fun insertStatus(statusType: String) {
        CoroutineScope(IO).launch {
